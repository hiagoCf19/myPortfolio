      ...
      <div className="flex lg:justify-center gap-8 lg:items-center lg:px-8">
        ...
        <div className=" flex flex-col sm:flex-1 lg:justify-end ">
          ...
          <div className=" flex gap-4 sm:flex-row flex-col ">
            ...
            <div className=" text-muted-foreground sm:mt-3 flex flex-col gap-5 text-justify">
              Estou atualmente cursando Desenvolvimento de Sistemas. Minha
              paixão pela tecnologia me levou a explorar o vasto campo do
              desenvolvimento de software. Após alguns anos estudando a
              interatividade com o usuário, venho expandindo meus estudos e
              projetos para englobar o universo Java, especialmente utilizando o
              framework Spring Boot.
              <br /> Isso tem impulsionado minha evolução constante no caminho
              fullstack. Sou dedicado ao aprendizado contínuo e estou sempre me
              atualizando para acompanhar as novas tecnologias que moldam o
