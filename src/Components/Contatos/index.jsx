...
const Contatos = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.send("service_7e3f2ml", "template_cjtbz7r", templateParams, "S0oRhtVBnuiDASR8N")
      .then((response) => {
      ...
      <div className="flex justify-center items-center">
        <div className="w-[800px] flex flex-col-reverse sm:flex-row">
          <div className="sm:w-[300px] flex flex-col gap-8 my-8 sm:ml-0 mx-12 sm:px-0">
            <ContatosCpn
              icon={<MdSmartphone size={30} color={`${themeState === false ? '#4a00e0' : '#000000'}`} />}
              title={"Telefone"}
            ...
            <ContatosCpn
              icon={<MdSmartphone color={`${themeState === false ? '#4a00e0' : '#000000'}`} size={30} />}
              title={"Localização"}
            ...
            <form onSubmit={sendEmail}>
              ...
              <div className="flex sm:gap-4 gap-6 flex-col sm:flex-row justify-center sm:justify-normal items-center sm:items-start">
                ...
                <div className="flex-1 flex flex-col gap-3">
                  ...
                  <InputStyle themestate={themeState}
                    type="text"
              ...
              <div className=" sm:w-[410px] flex flex-col gap-4 ">
                ...
                <label htmlFor="mensagem" className="ml-10 sm:ml-0 mt-4 sm:mt-4"> Escreva sua mensagem:</label>
                <div className="flex sm:justify-normal justify-center sm:items-start items-center">
                  <TextAreaStyle themestate={themeState}
                ...
                <div className="flex justify-center ">
                  <SubmitStyle themestate={themeState}>
                    <input
                      type="submit"
                      value={mensagemEnviada === false ? 'ENVIAR' : 'EMAIL ENVIADO'}
                    />
                  </SubmitStyle>
                </div>
              </div>
