...
const Welcome = () => {
  ...
  return (
    <section
      className="sm:mt-[65px] mt-[-65px] flex flex-col gap-8"
      id="Seja-Bem-Vindo"
    >
      <div className="flex  box-content sm:gap-[20%] gap-16 flex-col-reverse sm:flex-row mt-[-90px] sm:mt-2 overflow-x-hidden">
        ...
        <div className=" sm:flex-1 flex sm:flex-col justify-center sm:mt-0 mt-[220px] items-center  ">
          ...
          {/* MINHA FOTO */}
          <div
            className={`sm:w-[650px] sm:h-[650px] sm:rounded-lg w-[220px] h-[220px] sm:mt-[40px] sm:hidden rounded-full border-[4px] border-solid ${
              themeState === false
                ? "border-primaryDark"
                : "border-secondaryLig"
            } flex  items-center`}
