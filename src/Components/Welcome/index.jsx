...
const Welcome = () => {
  ...
  return (
    ...
    <section className=" sm:p-6 px-4 sm:px-[7.5rem] mt-[-65px] flex flex-col gap-8" id="Seja-Bem-Vindo">
      <div className="flex  h-[100vh] box-content  sm:gap-28 flex-col-reverse sm:flex-row mt-[-90px] sm:mt-2 overflow-x-hidden">
        <div className="w-min-max flex-1 flex flex-col gap-12 justify-center items-center border">
          ...
          <div className="flex flex-col ml-[-50px] gap-6 sm:gap-0 mt-[-42px]">
            <div>
              <h1 className="sm:text-[60px] text-[40px] sm:w-[420px] w-[280px] h-[80px] sm:h-[140px] font-bold">  Olá, eu sou <br />
                <strong className={`
                ${themeState === false ? ' text-transparent bg-clip-text bg-gradient-to-r from-[#8e2de2] to-[#4a00e0] ' : 'text-transparent bg-clip-text bg-gradient-to-r from-[#000000] to-[#6c7161] '}
            ...
            <span className={`text-[20px] ${themeState === false ? 'text-[#a7a7a7]' : 'text-[#000000]'} font-medium `}> <Typing speed={100} eraseDelay={999999999} text={['Desenvolvedor Front-end']} /></span>
          </div>

          {/* MEUS ICONES PERSONALIZADOS */}
          <div
            className="flex sm:w-[400px] w-[300px] gap-6 sm:ml-[-60px]">
            <a href="https://github.com/hiagoCf19" target="_blank">
              <GithubIcon />
            </a>
            <a href="https://www.linkedin.com/in/hiago-celmo-ferreira-de-jesus-6a5306230/" target="_blank">
              <LinkedinIcon />
            </a>
