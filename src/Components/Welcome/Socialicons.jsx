...
.baseDark{
  ...
  box-shadow: ${({ themestate }) =>
    themestate
      ? '0px 0px 10px rgb(36, 33, 33);'
      : '0px 0px 10px rgb(105, 127, 255); '
  };
  overflow: hidden;
...
export const LinkedinIcon = () => {
  ...
  return (
    <IconsStyle themestate={themeState}>
      <svg viewBox="0 0 496 512" height="1.6em" xmlns="http://www.w3.org/2000/svg"><g id="7935ec95c421cee6d86eb22ecd125aef">
...
export const WhatsAppIcon = () => {
  ...
  return (
    <IconsStyle themestate={themeState}>
      ...
      <svg fill="#FFF" height="1.7rem" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"
